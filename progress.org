...
*** TODO get_offsets in cgr_cal needs to add eeprom dict items
*** TODO write_cal in utils needs to write eeprom values
*** TODO load_cal in utils needs to read eeprom and store values
