...
** TODO What are good values for slope and offset?
   - I'm looking at an offset value of about 513 mV.  This is 11.3
     ...
     counts.  I could either have the offset stored as half-counts,
     or as centivolts.  I like centivolts.  Of course, if the user
     actually calibrates, they'll get more precision.
