...
** DONE Restructure project to have a tools directory
   - The tools directory will have the cgr-capture and cgr-cal
     ...
     pelican, and use the console scripts method to create executables.
* cgr-capture script
** TODO What happens if cgr-capture is run from whatever directory?
